...
These are **operating instructions only** — for what Loadsmith is, its
architecture, and design rationale, read [README.md](../README.md), the docs
under [`docs/src`](../docs/src),
